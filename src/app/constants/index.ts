...
export const API_ENDPOINTS = {
  ...
  BET: {
    ...
    PREDICTION_HISTORY: '/api/bet/prediction/history',
  },
  PAYMENT: {
    SEND: '/pay/send',
  ...
  OATH: {
    ...
    GITHUB_CALLBACK_LOGIN: '/social/github/callback/login',
    GITHUB_LOGIN: '/social/github/login',
