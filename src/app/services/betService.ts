...
export const betService = {
  ...
  getWinHistory: (page = 0, pageSize = 5, user?: number, sport?: string, findEnded?: boolean) =>
    apiClient.get<PageUserWinBetDto>(API_ENDPOINTS.BET.WIN_HISTORY, { page, pageSize, user, sport, findEnded }),

  getScoreHistory: (page = 0, pageSize = 5, user?: number, sport?: string, findEnded?: boolean) =>
    apiClient.get<PageUserScoreBetDto>(API_ENDPOINTS.BET.SCORE_HISTORY, { page, pageSize, user, sport, findEnded }),

  getPredictionHistory: (page = 0, pageSize = 5, user?: number, findEnded?: boolean) =>
    apiClient.get<PageUserBetPredictionDto>(API_ENDPOINTS.BET.PREDICTION_HISTORY, { page, pageSize, user, findEnded }),
};
